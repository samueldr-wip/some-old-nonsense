...
let
  ...
  bootargs = lib.concatStringsSep " " [
    ...
    "mtdparts=NOR_FLASH:0x00060000(BOOT)ro,0x00200000(KERNEL)ro,0x00010000(KEY_CUST)ro,0x00020000(LOGO),0x001c0000(rootfs)"#,0x00370000(miservice),0x00770000(customer),0x000d0000(appconfigs)"
  ];
